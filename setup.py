...
about = {}
with open(os.path.join(base_dir, "flake8_banned_words", "__init__.py")) as f:
    exec(f.read(), about)
...
setuptools.setup(
    ...
    url="https://github.com/i02sopop/flake8-banned-words",
    ...
    entry_points={
        'flake8.extension': [
            'W = flake8_banned_words.banned:BannedWords',
        ],
    },
